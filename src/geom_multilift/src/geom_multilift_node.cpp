...
GeomMultiliftNode::GeomMultiliftNode(int drone_id, int total_drones)
: Node("geom_multilift_" + std::to_string(drone_id))
, drone_id_(drone_id)
...
, payload_omega_init_(false)
{
  ...
  std::string data_root = this->declare_parameter(
    "data_root",
    std::string("data/preprocessed/rg_001_-001_3quad_l1m_100hz"));
  ...
  // offline data
  data_ = std::make_shared<DataLoader>(data_root, total_drones_);
  ...
  payload_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(
    payload_pose_topic, 10, std::bind(&GeomMultiliftNode::payload_pose_cb, this, _1));
  ...
  odom_sub_ = this->create_subscription<px4_msgs::msg::VehicleOdometry>(
    ...
    std::bind(&GeomMultiliftNode::odom_cb, this, _1));
  ...
  timer_ = this->create_wall_timer(
    ...
    std::bind(&GeomMultiliftNode::timer_cb, this));
}

Eigen::Matrix3d GeomMultiliftNode::hat(const Eigen::Vector3d &v) const {
  Eigen::Matrix3d m;
  m << 0, -v.z(), v.y(),
       v.z(), 0, -v.x(),
      -v.y(), v.x(), 0;
...
Eigen::Quaterniond GeomMultiliftNode::quat_from_msg(const geometry_msgs::msg::PoseStamped &msg) const {
...
Eigen::Quaterniond GeomMultiliftNode::quat_from_px4(const px4_msgs::msg::VehicleOdometry &msg) const {
  return Eigen::Quaterniond(msg.q[0], msg.q[1], msg.q[2], msg.q[3]);
}

Eigen::Vector3d GeomMultiliftNode::vee(const Eigen::Matrix3d &M) const {
...
Eigen::Vector3d GeomMultiliftNode::lowpass(
...
bool GeomMultiliftNode::all_ready() const {
...
void GeomMultiliftNode::payload_pose_cb(const geometry_msgs::msg::PoseStamped::SharedPtr msg) {
...
void GeomMultiliftNode::odom_cb(const px4_msgs::msg::VehicleOdometry::SharedPtr msg) {
...
void GeomMultiliftNode::lps_setpoint_cb(const px4_msgs::msg::VehicleLocalPositionSetpoint::SharedPtr msg) {
  drone_acc_sp_ = Eigen::Vector3d(msg->acceleration[0], msg->acceleration[1], msg->acceleration[2]);
}

void GeomMultiliftNode::state_cb(const std_msgs::msg::Int32::SharedPtr msg) {
...
void GeomMultiliftNode::swarm_state_cb(const std_msgs::msg::Int32::SharedPtr msg, int other) {
  swarm_states_[other] = static_cast<FsmState>(msg->data);
}

void GeomMultiliftNode::compute_desired(double t) {
...
void GeomMultiliftNode::run_control(double sim_t) {
...
void GeomMultiliftNode::timer_cb() {
...
void GeomMultiliftNode::log_sample(double sim_t,
