#!/usr/bin/env python3
"""
Launch the realflight geometric multilift controller with swarm GOTO/TRAJ coordinator.
"""
...
def generate_launch_description():
    ...
    default_params = PathJoinSubstitution([
        ...
        "config",
        "geom_multilift_realflight_params.yaml",
    ])
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='YAML file with geom_multilift realflight parameters'
        ),
        DeclareLaunchArgument(
            'takeoff_alt',
            default_value='0.4',
...
def launch_setup(context, *args, **kwargs):
    ...
    geom_node = Node(
        ...
        executable='geom_multilift_realflight_node',
        name=f'geom_multilift_realflight_node_{this_drone_id}',
        namespace='',
    ...
    nodes.append(
        LogInfo(
            msg=(
                f'Drone {this_drone_id}: launching geom_multilift_realflight + goto/TRAJ coordinator '
