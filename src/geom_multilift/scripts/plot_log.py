#!/usr/bin/env python3
"""
Quick plotting for geom_multilift logs produced by log_path parameter.
Columns expected:
...
def plot_errors(data):
    ...
    # ---------------- Payload attitude/body rates ----------------
    # Prefer computing Euler angles from quaternion to avoid any legacy logs where
    # rpy_* was computed with a different branch choice.
...
def main():
    parser = argparse.ArgumentParser(description="Plot geom_multilift log CSV")
    parser.add_argument("log_path", help="Path to CSV log from geom_multilift log_path param")
