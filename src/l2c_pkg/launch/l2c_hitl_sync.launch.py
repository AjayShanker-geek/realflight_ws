#!/usr/bin/env python3
"""
Launch the HITL L2C controller with swarm GOTO/TRAJ coordinator.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='YAML file with L2C HITL parameters'
        ),
        DeclareLaunchArgument(
            'takeoff_alt',
            default_value='0.4',
...
def launch_setup(context, *args, **kwargs):
    ...
    l2c_node = Node(
        package='l2c_pkg',
        executable='l2c_node',
        name=f'l2c_hitl_node_{this_drone_id}',
        namespace='',
    ...
    nodes.append(
        LogInfo(
            msg=(
                f'Drone {this_drone_id}: launching L2C HITL + goto/TRAJ coordinator '
