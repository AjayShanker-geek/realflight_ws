#!/usr/bin/env python3
"""
Launch the realflight PVA controller with swarm GOTO/TRAJ coordinator.
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    pva_node = Node(
        ...
        name=f'pva_realflight_node_{this_drone_id}',
        namespace='',
    ...
    nodes.append(
        LogInfo(
            msg=(
                f'Drone {this_drone_id}: launching PVA realflight + goto/TRAJ coordinator '
