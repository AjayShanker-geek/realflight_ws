#!/usr/bin/env python3
"""
Launch the HITL PVA controller with swarm GOTO/TRAJ coordinator.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='YAML file with PVA HITL parameters'
        ),
        DeclareLaunchArgument(
            'takeoff_alt',
            default_value='0.4',
...
def launch_setup(context, *args, **kwargs):
    ...
    pva_node = Node(
        ...
        name=f'pva_hitl_node_{this_drone_id}',
        namespace='',
    ...
    nodes.append(
        LogInfo(
            msg=(
                f'Drone {this_drone_id}: launching PVA HITL + goto/TRAJ coordinator '
