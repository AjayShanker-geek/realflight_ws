#!/usr/bin/env python3
"""
Launch per-drone smooth-feedback PVA control for realflight without coordinator.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="YAML file with smooth feedback PVA realflight parameters"
        ),
        LogInfo(msg=["Starting smooth feedback PVA realflight for drone ",
                     LaunchConfiguration("drone_id")]),
        Node(
            package="pva_control",
            executable="pva_smooth_feedback_control_node",
            name="pva_smooth_realflight",
            output="screen",
            arguments=[
                LaunchConfiguration("drone_id"),
