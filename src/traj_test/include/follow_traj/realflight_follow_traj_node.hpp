#ifndef REALFLIGHT_FOLLOW_TRAJ_NODE_HPP
#define REALFLIGHT_FOLLOW_TRAJ_NODE_HPP
...
class RealflightFollowTrajNode : public rclcpp::Node
{
public:
  explicit RealflightFollowTrajNode(int drone_id, int total_drones);
...
#endif // REALFLIGHT_FOLLOW_TRAJ_NODE_HPP
