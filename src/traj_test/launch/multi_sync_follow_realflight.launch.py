...
def generate_launch_description():
    ...
    csv_base_path_arg = DeclareLaunchArgument(
        'csv_base_path',
        default_value='data/realflight_traj_new',
...
def launch_setup(context, *args, **kwargs):
    ...
    follow_traj_node = Node(
        package='traj_test',
        executable='realflight_follow_traj_node',
        name=f'realflight_follow_traj_node_{this_drone_id}',
        namespace='',
    ...
    nodes.append(
        LogInfo(
            msg=(
                f'Drone {this_drone_id}: launching realflight_follow_traj + goto/TRAJ coordinator '
